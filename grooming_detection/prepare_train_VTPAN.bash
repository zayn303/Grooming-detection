...
LOG_DIR="$PROJECT_ROOT/logs/VTPAN"
OUTPUT_DIR="$PROJECT_ROOT/outputs/VTPAN"

# Directory paths for metadata
TRAIN_METADATA_PATH="$PROJECT_ROOT/translated_data/VTPAN/csv/VTPAN-train-exp-sk.csv" 
VAL_METADATA_PATH="$PROJECT_ROOT/translated_data/VTPAN/csv/VTPAN-val-exp-sk.csv"   
